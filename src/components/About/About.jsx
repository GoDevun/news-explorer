  ...
  return (
    <section className="about">
      <img
        ...
        src={authorPhoto}
        alt="Devun Cooksey, author of the project"
      />
      <div className="about__info">
        <h2 className="about__title">About the author</h2>
        <p className="about__text">
          Hi, I&apos;m Devun, a software engineer and graduate of the TripleTen
          Software Engineering program. Throughout the program I built a series
          of full-stack applications, working with HTML, CSS, JavaScript, React,
        ...
        <p className="about__text">
          ...
          opportunities where I can keep growing as a developer and contribute
